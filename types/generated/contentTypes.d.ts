...
export interface ApiPaymentPayment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    method: Schema.Attribute.Enumeration<['cash', 'digital']> &
      Schema.Attribute.Required;
    order: Schema.Attribute.Relation<'oneToOne', 'api::order.order'> &
      Schema.Attribute.Required;
    progress: Schema.Attribute.Enumeration<['process', 'completed']> &
      Schema.Attribute.DefaultTo<'process'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiReturnReturn extends Struct.CollectionTypeSchema {
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descriptionProfile: Schema.Attribute.Text;
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
    ...
    userParent: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    users: Schema.Attribute.Relation<
